...
class TestEmail < Test::Unit::TestCase
  ...
  context 'for #deliver method' do
    should "send mail with attributes default to sendmail no smtp" do
      email = Padrino::Mailer::Message.new(:to => "test@john.com", :from => "sender@sent.com", :body => "Hello")
    ...
    should "send mail with attributes default to smtp if set" do
      email = Padrino::Mailer::Message.new({:to => "test@john.com", :from => "admin@johnson.com", :body => "Hello"}, { :host => 'smtp.gmail.com' })
    ...
    should "send mail with attributes use sendmail if explicit" do
      email = Padrino::Mailer::Message.new({:to => "test@john.com", :from => "admin@johnson.com", :via => 'sendmail' }, { :host => 'smtp.gmail.com' })
